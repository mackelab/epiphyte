# Modify an existing database and workflow

### **Goal:**

add a table to an existing database and use it in an existing workflow

### **Requirements:**

- completion of all non-optional previous tutorials

### **Steps:**

1. Design the new table
2. 

### 1. Design the new table

- import necessary modules 
- define the structure of the Ttble (primary keys, other keys)
