...
If..
* you want to test infrastructure or run a VM on a personal computer, [here's a tutorial on setting up a VM locally.](https://www.freecodecamp.org/news/what-is-a-virtual-machine-and-how-to-setup-a-vm-on-windows-linux-and-mac/)
...
\* For this tutorial, we used [Ubuntu Focal (20.04.2 LTS)](http://old-releases.ubuntu.com/releases/20.04.2/). 
