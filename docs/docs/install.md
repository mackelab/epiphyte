...
[Install locally,](tutorials/1a. Launch a MySQL database locally.md)

[and continue to *Configure and connect to the database*.](tutorials/4. Configure and connect to a database.md)
...
[Install on a server-hosted virtual machine,](tutorials/1b. Launch the MySQL database on a virtual machine.md)

[and continue to *Install and set up Epiphyte*.](tutorials/3. Install Epiphyte locally or remotely.md)
...
[Start at *Launch the MySQL database on a virtual machine* and continue through the remaining tutorials.](tutorials/1b. Launch the MySQL database on a virtual machine.md)
