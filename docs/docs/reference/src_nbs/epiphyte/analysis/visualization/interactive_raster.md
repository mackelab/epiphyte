...
```
    ...
    Epiphyte dev version loaded.
    Please enter DataJoint username: root
    Please enter DataJoint password: ········
    Connecting root@localhost:3306
    Epiphyte launch version loaded
...
```python
raster_plot_holoviews.make_static_raster()
```
...
(pn.Column(
    ...
    pn.Row(pn.panel(raster_plot_holoviews.p.param, parameters=['patient_id', 'session_nr', 'highlight'], show_name=False)), rasterplot,
    ...
    pn.Row(
        ...
        pn.Column("### &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Overview Box Edit Data", pn.panel("{}/visualization/images/explanation_boxes.png".format(config.PATH_TO_REPO), width=500, ), align='end')),
